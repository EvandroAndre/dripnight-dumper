...
public class BE_BlockSectionHeader_GraphVarNameInput : MonoBehaviour, JINIKKACLOC
{
	public VarDefineData VarRef;
	...
	private string MKNIHGFMGBA;

	private Transform PMKEBIPFHFI;

	private ValueData LMJIEGNJMOE;
	...
	private FAFJBOCLLDM FNCOIBGEADG;
	...
	Transform JINIKKACLOC.MKFNHMPDLPE => null;
	...
	private void FJDJNCCJLFC()
	{
	}

	private void KHOFJPAMDPD()
	{
	}

	private void FHPBMALIBBM()
	{
	}
	...
	public void InitVarRef(VarDefineData KKKIDEIAMOP)
	{
	}
	...
	private void PJGGBIDLPBI()
	{
	}

	private void HGNGAKBNAGE()
	{
	}
}
