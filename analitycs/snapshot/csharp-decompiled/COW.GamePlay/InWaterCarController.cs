...
internal class InWaterCarController : RCC_CarControllerV3, LEDGHNBKNPP
{
	private sealed class GGCFIAIBJMB : IEnumerator<object>, IEnumerator, IDisposable
	{
		private int CBPPJACCGOH;

		private object MHDKFGLHFKH;

		public InWaterCarController KOKNHFGCGLN;
		...
		public GGCFIAIBJMB(int CBPPJACCGOH)
		{
		}
	...
	private sealed class JECFEPILMCA : IEnumerator<object>, IEnumerator, IDisposable
	{
		private int CBPPJACCGOH;
		...
		public JECFEPILMCA(int CBPPJACCGOH)
		{
		}
	...
	public override bool NJHEMAJLAMM => false;
	...
	public override void KillEngine()
	{
	}

	public override void VehicleUpdateInput(bool NCPIMBDABPG, bool FGBKMCEIMNI, Vector3 PMIKOMKJPBF)
	{
	}

	public override void VehicleUpdateInput(float NCPIMBDABPG, float FGBKMCEIMNI, Vector3 PMIKOMKJPBF)
	{
	}
	...
	private void OIFIEFKBAJD()
	{
	}

	private void OBNDONJDKLI(RCC_WheelCollider GHFNCGHOBKC)
	{
	}
	...
	private void LHKHOJDDDME()
	{
	}

	private void MAHAPHMPGLA()
	{
	}
	...
	public bool _003C_003EiFixBaseProxy_get_IsGrounded()
	{
		return false;
	}

	public void _003C_003EiFixBaseProxy_StartEngine()
	{
	}

	public void _003C_003EiFixBaseProxy_KillEngine()
	{
	}

	public void _003C_003EiFixBaseProxy_VehicleUpdateInput(bool P0, bool P1, Vector3 P2)
	{
	}

	public void _003C_003EiFixBaseProxy_VehicleUpdateInput(float P0, float P1, Vector3 P2)
	{
	}
