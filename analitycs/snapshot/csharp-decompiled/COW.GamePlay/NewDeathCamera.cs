...
internal class NewDeathCamera : FollowCamera
{
	public static readonly float C_OFFSET_RIGHT_REVIVING;

	public static readonly float C_OFFSET_UP_REVIVING;

	public static readonly float C_OFFSET_BACK_REVIVING;

	public static readonly float C_MOVE_DELAY;

	private float KLDNHOLDNIH;

	private bool ILCFCKOHFFG;

	private float DBNFEJMLCOK;

	private float CFINCAKIOBG;

	private float FIMJFPDLMGH;

	private float LGOHBKAEJMP;

	private float BPAKBJPHKNN;

	public static readonly float TotalLerpTime;

	private Quaternion FADGEMFJHEI;

	protected override float DLMBENJNCEA => 0f;
	...
	public float _003C_003EiFixBaseProxy_MAMHBFIJNOH()
	{
		return 0f;
	}
