...
public class SceneEditObjectVendingMachine : SceneEditObjectAttrBase
{
	public string BindingLogicEntityID;

	public float m_TriggerRadius;

	public bool ModelShow;

	private bool OKLFPOEHHPE;

	public float CPHDNLMIDAM
	{
		get
		{
			return 0f;
