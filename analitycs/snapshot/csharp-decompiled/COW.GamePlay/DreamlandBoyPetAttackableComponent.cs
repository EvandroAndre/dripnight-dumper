...
internal class DreamlandBoyPetAttackableComponent : AttackableEntity
{
	private uint MFIMOMJGIFK;

	private BHGGAEEHJCO KEJOLKCHCJP;
	...
	internal void LMNGOJOJFNM(uint EICALHOFJEG)
	{
	}
