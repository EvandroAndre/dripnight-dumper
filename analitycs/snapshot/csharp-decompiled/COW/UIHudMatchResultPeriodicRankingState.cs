...
public class UIHudMatchResultPeriodicRankingState : UIHudMatchResultStateBase
{
	public UIHudMatchResultPeriodicRankingState(UIHudMatchResultStateMachine machine)
