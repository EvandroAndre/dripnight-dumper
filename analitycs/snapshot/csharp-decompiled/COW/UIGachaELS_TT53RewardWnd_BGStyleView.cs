...
public class UIGachaELS_TT53RewardWnd_BGStyleView : UIBaseView
{
	...
	public UISprite TokenGotVFXToken;
	...
	public Transform TitleBGVFX;

	public UISprite TitleBG;

	public GameObject GotTokenVFX;

	public Animation TokenMaskAnimation;

	public Animation BGStyleAnim;
