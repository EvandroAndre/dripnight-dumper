...
public class UIBigEvent_CustomTC_TokenPopWndController : UIPopupWindowController, IEasyList, IBigEventTemplateIdentifier
{
	private UIBigEvent_CustomTC_TokenPopWndView m_View;
