...
public class UIHudMatchResultHippoCrisisRankingRewardState : UIHudMatchResultStateBase
{
	private UIModelHippoCrisisLadderMatch m_HippoCrisisLadderMatch;

	public UIHudMatchResultHippoCrisisRankingRewardState(UIHudMatchResultStateMachine machine)
