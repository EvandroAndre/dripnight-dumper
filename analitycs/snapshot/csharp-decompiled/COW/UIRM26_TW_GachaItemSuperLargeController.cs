...
public class UIRM26_TW_GachaItemSuperLargeController : UIBaseController, IUIRM26TWGachaItemController
{
	protected Action<int> m_onClickFunc;

	protected uint m_GachaID;

	protected UIRM26_TW_GachaItemSuperLargeView m_View;
	...
	private string m_FixedIconSpriteName;
