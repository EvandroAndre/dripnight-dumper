...
public class UIChangeNameFriendAliasController : UIChangeNameBaseController
{
	...
	public void RefreshViewData(ulong friend_ID)
	{
	}

	private void RefreshInputNewNameView()
	{
	}
