...
public class UIBigEvent_Template_BtnItemBaseController : UIBaseController, IUIModelDataChangeObserver, IBigEventTemplateIdentifier
{
	...
	protected virtual void RefreshEntranceEffect(bool result)
	{
	}
