...
public class UIRM26_TW_GachaExchangeItemController : UIBaseController
{
	public UIRM26_TW_GachaExchangeItemView m_View;
	...
	public bool IsExchangeAffordable()
	{
		return false;
	}

	public void ShowHideExchangeContainer(bool show)
	{
	}
