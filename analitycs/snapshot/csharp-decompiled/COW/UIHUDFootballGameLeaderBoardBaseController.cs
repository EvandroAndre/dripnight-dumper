...
internal class UIHUDFootballGameLeaderBoardBaseController<T> : UIBaseController where T : UIHUDFootballGameLeaderBoardItemBaseController
{
	protected UIHudFootballGameLeaderBoardView m_View;
