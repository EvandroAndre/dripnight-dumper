...
public class UGCMatchInfoSubTitleHudRepItem
{
	public const int PROP_ID_OPENSTATE = -1022000;

	public const int PROP_ID_LOCSWITCH = -1022001;

	public const int PROP_ID_TEXTKEY = -1022002;

	public const int PROP_ID_TEXTKEY_PARAMS = -1022003;
	...
	public UGCMatchInfoSubTitleHudRepItem(string ownerEntityID)
	{
	}
