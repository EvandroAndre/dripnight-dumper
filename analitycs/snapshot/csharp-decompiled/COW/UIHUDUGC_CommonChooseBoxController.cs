...
public class UIHUDUGC_CommonChooseBoxController : UIPopupWindowController
{
	public delegate void OnBtnClicked(UIHUDUGC_CommonChooseBoxController ctrl);

	private UIHUDUGC_CommonChooseBoxView m_View;
