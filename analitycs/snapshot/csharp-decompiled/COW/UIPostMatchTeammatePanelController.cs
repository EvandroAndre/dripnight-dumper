...
internal class UIPostMatchTeammatePanelController : UIBaseController
{
	private UIPostMatchTeammatePanelView m_View;

	private List<UIPostMatchTeammateListItemController> m_TeammateListItemControllers;
