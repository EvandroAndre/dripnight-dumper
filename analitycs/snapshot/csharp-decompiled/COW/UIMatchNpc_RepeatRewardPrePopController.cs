...
public class UIMatchNpc_RepeatRewardPrePopController : UIPopupWindowController, IEasyList, IBigEventTemplateIdentifier
{
	[Serializable]
	...
	private UIMatchNpc_RepeatRewardPrePopView m_View;
