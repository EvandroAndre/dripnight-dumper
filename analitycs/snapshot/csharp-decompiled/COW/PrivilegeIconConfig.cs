...
public class PrivilegeIconConfig : CSVBaseData, IGetId
{
	public uint ID;
	...
	public ResourceID IconSpriteIngame;

	public string IconSpriteCollection;

	public ResourceID IconVFX;

	public bool InGameShow;

	public ResourceID IconSpriteCollectionTex;
