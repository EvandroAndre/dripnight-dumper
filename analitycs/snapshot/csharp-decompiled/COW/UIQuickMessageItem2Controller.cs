...
public class UIQuickMessageItem2Controller : UIEasyListItemController, IQuickMsgContainerData, IQuickMsgItemData, IUIModelDataChangeObserver
{
	private sealed class _003CDelayHideReplaceIcon_003Ed__24 : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		public UIQuickMessageItem2Controller _003C_003E4__this;
	...
	private UIQuickMessageSettingItem2View m_View;
	...
	private const int DragDropBtnDepth = 12;

	private Coroutine m_ReplaceIconCo;

	public int ContainerIdx => 0;
