...
public class UIGachaIchis55ShowItemController : UIBaseController
{
	private UIGachaIchis55ShowItemView m_View;
	...
	private static string GetRewardLoopVFXName(uint quality)
	{
		return null;
	}
