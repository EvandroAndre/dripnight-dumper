...
public class UIHudDirectionRulerView : UIBaseView
{
	...
	public Transform NoMaskedGroup;

	public UIHudDirectionRulerTeamMarkItem TeamMark;

	public GameObject ReviverMark;

	public UISprite ReviverProgress;

	public GameObject HippoCrisisRetreatMark;

	public UILabel CurRotLabel;
