...
public class UGCHelmetRepItem
{
	public const int PROP_ID_LEVEL = -155000;

	public const int PROP_ID_DURABILITYMAX = -155001;

	public const int PROP_ID_DURABILITY = -155002;

	public const int PROP_ID_DAMAGEREDUCTIONFACTOR = -155003;

	public const int PROP_ID_DAMAGEREDUCTIONFACTOREXPLODE = -155004;

	public const int PROP_ID_COSTDURABILITY = -155005;

	public const int PROP_ID_CANDESTROY = -155006;

	public const int PROP_ID_OWNER = -155007;
	...
	public UGCHelmetRepItem(string ownerEntityID)
	{
	}
