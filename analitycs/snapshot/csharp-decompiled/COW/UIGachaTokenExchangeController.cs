...
public class UIGachaTokenExchangeController : UIPreviewNavigationController, IUIModelDataChangeObserver, IEasyList
{
	...
	private bool _003CHighlightCurrent_003Eb__34_0(ChestSpecialExchangeDesc item)
	{
		return false;
	}
