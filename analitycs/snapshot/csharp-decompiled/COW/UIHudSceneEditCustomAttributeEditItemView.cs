...
public class UIHudSceneEditCustomAttributeEditItemView : UIBaseView
{
	public UILabel name;
	...
	public UIToggleButton ToggleSwitch;

	public UIColor Colorbg;

	public GameObject StringValue;

	public UIInputEnhance StringValueUIInput;
