...
public class UIHudMatchResultHippoCrisisRankingState : UIHudMatchResultStateBase
{
	public UIHudMatchResultHippoCrisisRankingState(UIHudMatchResultStateMachine machine)
