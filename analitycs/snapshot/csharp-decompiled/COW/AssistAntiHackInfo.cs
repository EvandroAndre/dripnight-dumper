...
public class AssistAntiHackInfo : IGameAssistItemData
{
	public EAntiHackType FeedbackType;

	public CreditReportInfo ReportInfo;

	public CreditCompensationInfo CompensationInfo;
