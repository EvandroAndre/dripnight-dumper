...
public class UIMallV2ItemBaseController : UIEasyListItemController
{
	...
	protected bool m_ReachItemLimitedCount;
	...
	protected GameObject CountLimitedTitle;
	...
	protected GameObject PrimeTips;

	protected GameObject PrimeLock;
	...
	public void HideAllTag(UIStandardItemMAXCItemTagController itemTagCtrl)
	{
	}
	...
	private void RepositionItemIcon()
	{
	}
	...
	protected virtual void SetCountLimitedTitleState()
	{
	}
	...
	protected virtual void RefrehPrimeItemShowState()
	{
	}
	...
	public UIStandardItemMAXCItemTagController GetItemTagCtrl(bool ensureCreated)
	{
		return null;
	}
