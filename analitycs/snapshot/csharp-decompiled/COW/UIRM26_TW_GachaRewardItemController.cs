...
public class UIRM26_TW_GachaRewardItemController : UIBaseController
{
	...
	private sealed class _003CPlayProgressBarAnim_003Ed__104 : IEnumerator<object>, IEnumerator, IDisposable
	{
		...
		public _003CPlayProgressBarAnim_003Ed__104(int _003C_003E1__state)
		{
		}
	...
	public UIRM26_TW_GachaRewardItemView m_View;
	...
	private UIRM26_TW_GachaRewardWndController m_CommonRewardWndController;
	...
	private UIRM26_TW_GachaRewardWndController CommonRewardWndController => null;
	...
	private void ShowHideRewardItemIconBg()
	{
	}
	...
	public void SetViewInfo(CommonRewardItemInfo info, UICommonRewardWndController.WndStyleEnum style = UICommonRewardWndController.WndStyleEnum.COMMON, bool useNewItem = false)
	{
	}
	...
	private void RefreshClanPrivilege(CommonRewardItemInfo info)
	{
	}
	...
	private void CheckIsLevelUpNewCharacter()
	{
	}
	...
	public void RefreshOptionalToggle(uint count, bool useNoTween = false)
	{
	}

	public void RefreshCurOptionalToggle(bool useNoTween = false)
	{
	}
	...
	private void CheckAndRefreshUsedStatus()
	{
	}
