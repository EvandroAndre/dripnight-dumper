...
public class UIBigEvent_CustomCard_PeakDayPopupWndView : UIBaseView
{
	...
	public UINetworkTexture TextureBtnClaimBg;

	public UISprite SpriteBtnClaimBg;

	public UINetworkTexture CliamedBtnTexture;

	public GameObject UIBigEvent_CustomCard_PeakDayPopupWnd;
