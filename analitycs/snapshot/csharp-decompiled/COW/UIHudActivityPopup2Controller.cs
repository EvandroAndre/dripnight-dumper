...
public class UIHudActivityPopup2Controller : UIBaseController
{
	...
	private UIHudActivityPopup2View m_View;
	...
	public void SetMessage(string message, string messag2, ResourceID showIcon, float duration, int yOffset = 0)
	{
	}
