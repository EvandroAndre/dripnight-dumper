...
public class GameVoiceImpl_FreeFireVoice : IGameVoiceInterface
{
	public class FFVoiceInitExtraConfig
	{
		...
		public string MagicVoiceValidDomain;

		public string MagicVoiceReportIP;
	...
	public const int RTC_EXT_SERVER = 10000;

	public const int RTC_DEFAULT_SERVER = 10001;

	private static string AppKey;

	private static string AppSecret;

	private static string MagicVoiceToken;

	private static long VoiceEncTimestamp;
	...
	private FFVoiceInitExtraConfig m_PendingExtraConfig;
	...
	private void ApplyExtraConfig(FFVoiceInitExtraConfig ffvoice_extra_config)
	{
	}
	...
	private FFMagicVoiceErrorCode SetMagicVoiceUserInfo()
	{
