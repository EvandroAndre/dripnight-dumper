...
public class UISeasonReplayDestinyWeaponThreeController : UIBaseController, IUISeasonReplayItem
{
	private UISeasonReplayDestinyWeaponThreeView m_View;
	...
	private uint m_Ticket_SEASONREPLAYDESTINYWEAPONTHREETITLE_VFX;

	private List<DestinyWeaponData> m_WeaponDatas;

	private List<UISeasonReplayDestinyWeaponItemController> m_ItemCtrls;

	private const string InAnimClip = "UIFX_UISeasonReplayDestinyWeapon_Three_In";

	private const string OutAnimClip = "UIFX_UISeasonReplayDestinyWeapon_Three_Out";

	private const float WeaponScaleCoefficient2_3 = 0.9f;
