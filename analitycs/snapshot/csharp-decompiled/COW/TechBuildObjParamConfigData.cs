...
public class TechBuildObjParamConfigData : CSVBaseData, IGetId
{
	public uint ID;

	public uint ConstructionObjType;

	public ResourceID ConstructionIcon;

	public ResourceID ConstructionSmallIcon;

	public string ConstructionTitle;

	public string ConstructionDesc;

	public string ConstructionDescCS;
