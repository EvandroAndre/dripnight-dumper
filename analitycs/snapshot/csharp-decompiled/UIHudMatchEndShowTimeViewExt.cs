...
public class UIHudMatchEndShowTimeViewExt
{
	public Behaviour Animator;
	...
	public UIHudMatchEndShowTimeViewExt(UIHudMatchEndShowTimeView baseView)
	{
	}

	public UIHudMatchEndShowTimeViewExt(UIHudMatchEndShowTime_NewView baseView)
	{
	}

	public UIHudMatchEndShowTimeViewExt(UIHudMatchEndShowTime_HippoCrisisView baseView)
	{
	}
}
